    ...
    <div className="py-6 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="mt-2 text-5xl font-semibold tracking-tight text-balance text-secondary-onyx sm:text-6xl">Our Financing Plan Suits You</h2>
          {/* <p className="mt-2 text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-6xl">
            Our Financing Plan Suits You
          </p> */}
        </div>
        <p className="mx-auto mt-6 max-w-4xl text-center text-lg font-medium text-pretty text-secondary-onyx/90 sm:text-xl/8">
        ...
        <div className="mt-16 sm:mt-4 flex justify-center">
          <RadioGroup
            ...
            className="grid grid-cols-2 gap-x-1 rounded-full p-1 text-center text-xs/5 font-semibold ring-1 ring-secondary-robinEggBlue ring-inset"
          >
            {frequencies.map((option) => (
              <RadioGroup.Option
                ...
                className={({ checked }) =>
                  classNames(
                    checked ? 'bg-secondary-darkCyan text-secondary-whiteSmoke' : 'text-secondary-onyx/80',
          ...
          {tiers.map((tier) => (
            <div
              ...
              className={classNames(
                tier.mostPopular ? 'ring-2 ring-secondary-darkCyan/80 bg-white' : 'ring-1 ring-gray-200 bg-white',
            ...
            >
              <div className="flex items-center justify-between gap-x-4">
                <h3
                  id={tier.id}
                  className={classNames(
                    tier.mostPopular ? 'text-secondary-lightGreen' : 'text-secondary-onyx',
                ...
                {tier.mostPopular ? (
                  <p className="rounded-full bg-secondary-robinEggBlue/10 px-2.5 py-1 text-xs/5 font-semibold text-secondary-darkCyan">
                    Most popular
                  </p>
                ) : null}
              </div>
              <p className="mt-4 text-sm/6 text-secondary-onyx/80">{tier.description}</p>
              <p className="mt-6 flex items-baseline gap-x-1">
                <span className="text-4xl font-semibold tracking-tight text-secondary-onyx">
              ...
              <a
                ...
                className={classNames(
                  tier.mostPopular
                    ? 'bg-secondary-orangeCTA text-white shadow-xs hover:bg-secondary-lightGreen/85'
